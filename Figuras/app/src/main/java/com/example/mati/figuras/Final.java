    ...
    public static class FiguraVisualizacion extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if(figura.equals("Circulo")){
                float radio = (float)Figura3.circulo.getRadio();
                ...
                textv6.setText(String.valueOf(Figura3.circulo.area()));

                canvas.drawCircle(x, y, radio, miPincel);
            }
            if(figura.equals("Cuadrado")) {
                float lado = (float) (Figura3.cuadrado.getLado());
                textv3.setText("Los Lados son: ");
                textv4.setText(String.valueOf(lado) + " x " + String.valueOf(lado));
                textv1.setVisibility(TextView.INVISIBLE);
                textv2.setVisibility(TextView.INVISIBLE);
                textv5.setText("Area es: ");
                textv6.setText(String.valueOf(Figura3.cuadrado.area()));
            ...
            if(figura.equals("Rectangulo")){
                float base = (float)(Figura3.rectangulo.getBase());
                float altura = (float)(Figura3.rectangulo.getAltura());
                ...
                textv5.setText("Area es: ");
                textv6.setText(String.valueOf(Figura3.rectangulo.area()));
