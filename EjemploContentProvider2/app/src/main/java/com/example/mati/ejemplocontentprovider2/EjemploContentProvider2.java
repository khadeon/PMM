package com.example.mati.ejemplocontentprovider2;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnConsultar.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
		        ...
		        String uri = "content://com.example.mati.ejemplocontentprovider.UsuariosProvider/usuarios";
        ...
        btnEliminar.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				//Eliminamos el usuario introducido con el bot�n de Insertar
